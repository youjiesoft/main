...
//				uploader : TP_PUBLIC + "/Js/uploadify/uploadify.php",
				...
				fileTypeDesc : $this.attr("fileTypeDesc") || "*.jpg;*.jpeg;*.gif;*.png;*.doc;*.xls;*.csv;*.zip;*.pdf;*.xlsx;*.ppt;*.docx;*.rar;*.html;*.htm;*.txt;",
				fileTypeExts : $this.attr("fileTypeExts") || "*.jpg;*.jpeg;*.gif;*.png;*.doc;*.xls;*.csv;*.zip;*.pdf;*.xlsx;*.ppt;*.docx;*.rar;*.html;*.htm;*.txt;",
				uploadLimit : $this.attr("uploadLimit") || "50",
				queueSizeLimit : $this.attr("queueSizeLimit") || "50",
				fileSizeLimit : $this.attr("fileSizeLimit") || "2000MB",
