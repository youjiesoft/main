...
//				uploader : TP_PUBLIC + "/Js/uploadify/uploadify.php",
				...
				fileTypeDesc : $this.attr("fileTypeDesc") || "*.rm;*.rmvb;*.mpeg4;*.mpeg3;*.mpeg2;*.mpeg1;*.mov;*.mtv;*.dat;*.wmv;*.avi;*.3gp;*.amv;*.jpg;*.jpeg;*.gif;*.png;*.doc;*.xls;*.csv;*.zip;*.pdf;*.xlsx;*.ppt;*.docx;*.rar;*.html;*.htm;*.txt;",
				fileTypeExts : $this.attr("fileTypeExts") || "*.rm;*.rmvb;*.mpeg4;*.mpeg3;*.mpeg2;*.mpeg1;*.mov;*.mtv;*.dat;*.wmv;*.avi;*.3gp;*.amv;*.jpg;*.jpeg;*.gif;*.png;*.doc;*.xls;*.csv;*.zip;*.pdf;*.xlsx;*.ppt;*.docx;*.rar;*.html;*.htm;*.txt;",
...
function changeAddress(obj){
	...
	var dizhi=$("#address_detail_address_"+obj).val();
	var address_detail=dizhi+'|'+xmap+'|'+ymap;
	$("#address_detail_"+obj).val(address_detail);		
}
				...
				$.ajax({
					...
					success:function(msg){
						if(msg){
							...
							// 默认加载项
							if(souce && souce[sel.attr(casecadeLevel)]){
