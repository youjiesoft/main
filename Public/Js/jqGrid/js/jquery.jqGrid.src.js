		...
		var ts= this, grid={
			...
			dragEnd: function() {
				...
				if(this.resizing) {
					...
					this.headers[idx].el.style.width = "100%";
...
$.fn.jqFilter = function( arg ) {
	...
	var p = $.extend(true,{
		...
		sopt : null,
		ops : [
			{"name": "eq", "description": "等于", "operator":"="},
			{"name": "ne", "description": "不等于", "operator":"<>"},
			{"name": "lt", "description": "小于", "operator":"<"},
			{"name": "le", "description": "小于等于","operator":"<="},
			{"name": "gt", "description": "大于", "operator":">"},
			{"name": "ge", "description": "大于等于", "operator":">="},
			{"name": "bw", "description": "开始", "operator":"LIKE"},
			{"name": "bn", "description": "不开始", "operator":"NOT LIKE"},
			{"name": "in", "description": "存在", "operator":"IN"},
			{"name": "ni", "description": "不存在", "operator":"NOT IN"},
			{"name": "ew", "description": "结束", "operator":"LIKE"},
			{"name": "en", "description": "不结束", "operator":"NOT LIKE"},
			{"name": "cn", "description": "包含", "operator":"LIKE"},
			{"name": "nc", "description": "不包含", "operator":"NOT LIKE"},
			{"name": "nu", "description": "为空", "operator":"IS NULL"},
			{"name": "nn", "description": "不为空", "operator":"IS NOT NULL"}
		],
	...
	searchGrid : function (p) {
		...
		return this.each(function() {
			...
			function showFilter(_filter) {
				//显示搜索框
                                $("#search_data_ghwcs").click(function(){
                                    $("#filter").css("display","block");
                                    if(jQuery("#filter").css("display")=="block") { 
