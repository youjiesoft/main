...
(function($) {
	...
	$.fn.calculator.format.createButton = function(button){
		...
		return $('<div class="calc-button-wrapper ui-widget-header" style="position:absolute;'+style+'"><div class="calc-button" style="left:0;right:0;bottom:0;position:absolute;text-align:center;text-decoration:none;top:0;">'+button.symbol+'</div></div>');
	}
