...
$NBM_BASEARCHIVESFIELD =array(
	...
	'name'			=>array('type'=>'varchar' , 	'length'=>'255' , 	'default'=>'0','isnull'=>'NULL' , 'desc'=>"COMMENT '名称'", 'title'=>'名称', 				'canuse'=>'1' , 'fieldcategory'=>'base'),
...
//系统预定义字段
$SYSTEM_FIELD=array("departmentid"=>'部门id', "sysdutyid"=>"职级id", "projectid"=>"项目id", "projectworkid"=>"任务id","companyid"=>"公司id","createid"=>"创建人id");
