...
return array(
	...
	'js-delete' => array(
		'ifcheck' => '1',
		'permisname' => 'toolbarconfig_delete',
		'extendurl' => '"modelname/".$_REQUEST["modelname"]',
	...
	//按钮在页面显示
	'js-buttonToPage' => array(
			'ifcheck' => '0',
			'permisname' => 'toolbarconfig_buttonToPage',
			'extendurl' => '"modelname/".$_REQUEST["modelname"]',
			'html' => '<a class="buttonToPage js-buttonToPage tml-btn tml_look_btn tml_mp" href="__URL__/buttonToPage/#extendurl#" rel="__MODULE__buttonToPage" target="dialog"   width="700" height="500" mask="true"><span><span class="icon icon-plus icon_lrp"></span>按钮页面显示</span></a>',
			'shows' => '1',
			'sortnum' => '4',
	),
);