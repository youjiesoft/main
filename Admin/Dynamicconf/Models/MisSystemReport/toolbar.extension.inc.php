...
return array(
	...
	'js-delete' => array(
		...
		'html' => '<a class="js-delete delete tml-btn tml_look_btn tml_mp" href="__URL__/delete/rel/missystemreportlookupindex" rel="id" postType="string" class="delete" target="selectedTodo" title="你确定要删除吗？" warn="请选择一条组申请"><span><span class="icon icon-trash icon_lrp"></span>删除</span></a>',
		'shows' => '1',
		'sortnum' => '7',
	),
);