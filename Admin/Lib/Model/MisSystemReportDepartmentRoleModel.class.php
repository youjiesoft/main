 ...
 * @version V1.0
 */
class MisSystemReportDepartmentRoleModel extends CommonModel {
	protected $trueTableName = 'mis_system_report_department_role';
	/**
	 *
	 ...
	 * @throws
	 */
	public function getDepartRoleReport(){
