 ...
 * @version V1.0
 */
class WXHelperAction extends Action {
	...
	//引入微信接口类
	import("@.ORG.Wechat");
	$wechat = new Wechat('eagle_accountingcn', TRUE);
    $wechat->run();
    ...
    protected function receiveEvent($object)
    {
        ...
        {
            case "subscribe":
                $contentStr = "欢迎关注岭南园林股份有限公司官方微信！为关注岭南成长与发展的朋友们分享公司动态、精品项目、文化法动等资讯，您的见证是岭南人的动力！";
            case "unsubscribe":
                break;
            case "CLICK":
                switch ($object->EventKey)
                {
                    case "company":
                        ...
                        "Description" =>"岭南园林股份有限公司\n深交所A股上市，股票代码002717\n国家城市园林绿化壹级资质\n风景园林工程设计甲级资质\n国家高新技术企业\n全国十强园林企业\n中国风景园林企业“优秀管理奖”\n项目屡获国家级园林设计及工程金奖\n广东省农业龙头企业\n广东省风景园林协会副会长单位\n连续10年被评为广东省“守合同 重信用”企业\n...... \n ", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/company/companysqure.jpg", 
                        "Url" =>"http://zxqydl.sinaapp.com/company/company.html");
                        break;
					case "businesskey":
                        $contentStr[] = array("Title" =>"业务介绍", 
                        "Description" =>"中国风景园林企业综合竞争力第六名、中国风景园林50强企业、国家高新技术企业、广东省风景园林企业20强第三名、广东省优秀园林企业、广东省风景园林协会副会长单位、广东省民营科技企业、广东省重点农业龙头企业、广东生态园林产业技术创新战略联盟理事长单位、广东省园林绿化生态营建与修复工程技术研究中心、东莞市农业龙头企业、东莞市园林绿化行业协会理事长单位、连续十年被评为 “守合同、重信用企业”等； ", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/project/123.png", 
                        "Url" =>"http://zxqydl.sinaapp.com/project/wedetail.html");
                        
                        $contentStr[] = array("Title" =>"园林工程施工", 
                        "Description" =>"  ", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/project/sgmain.jpg", 
                        "Url" =>"http://zxqydl.sinaapp.com/project/wedetail1.html");
 
                         $contentStr[] = array("Title" =>"景观规划设计 ", 
                        "Description" =>" ", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/project/j01.jpg", 
                        "Url" =>"http://zxqydl.sinaapp.com/project/wedetail3.html");
                        
                        $contentStr[] = array("Title" =>"绿化养护", 
                        "Description" =>" ", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/project/l01.jpg", 
                        "Url" =>"http://zxqydl.sinaapp.com/project/wedetail4.html");
                        
                        $contentStr[] = array("Title" =>"苗木基地", 
                        "Description" =>" ", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/project/mmmain.jpg", 
                        "Url" =>"http://zxqydl.sinaapp.com/project/wedetail5.html");
                        
                        $contentStr[] = array("Title" =>"园林科学研究", 
                        "Description" =>" ", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/project/y01.jpg", 
                        "Url" =>"http://zxqydl.sinaapp.com/project/wedetail6.html");
                        break;
                    case "culturekey":
						$contentStr[] = array("Title" =>"企业文化", 
                        "Description" =>"岭南园林的发展与企业文化紧密相连，在岭南，你可以感受到和谐的团队氛围、奋发向上的精神与先进的管理理念；在岭南，你可以接受到良好的职业培训并获得最大的晋升空间。岭南，是你梦想起飞和实现的地方...", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/culture/20130516161733833.jpg", 
                        "Url" =>"http://zxqydl.sinaapp.com/culture/wemenu.html");
                        $contentStr[] = array("Title" =>"企业理念 - 价值观·愿景...", 
                        "Description" =>"企业理念 ", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/culture/2_111101154701_1.jpg", 
                        "Url" =>"http://zxqydl.sinaapp.com/culture/wedetail.html");
                        $contentStr[] = array("Title" =>"员工活动 - 文体·公益...", 
                        "Description" =>"员工活动", 
                        "PicUrl" =>"http://www.lnlandscape.com/webadmin/htmledit/UploadFile/2008129142813209.jpg", 
                        "Url" =>"http://zxqydl.sinaapp.com/culture/wedetail1.html");
                        $contentStr[] = array("Title" =>"党团建设 - 党建·党团活动...", 
                        "Description" =>"党团建设", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/culture/tt.jpg", 
                        "Url" =>"http://zxqydl.sinaapp.com/culture/wedetail2.html");
                        $contentStr[] = array("Title" =>"岭南培训 - 内训·外训...", 
                        "Description" =>"岭南培训", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/culture/2457331_114230484000_2.jpg", 
                        "Url" =>"http://zxqydl.sinaapp.com/culture/wedetail3.html");
   						break;
 					case "hrkey":
                        $contentStr[] = array("Title" =>"人力资源", 
                        "Description" =>"海纳百川 唯才是举 我们认为，人才是企业的第一生产力。因此，岭南在创立之初就十分重视人才，一直将人才摆在企业战略发展的首位。10年的发展、探索和总结，使得我们在选人才、用人才、育人才、留人才等方面都形成了适合自己的一套行之有效人才观念，归结下来，主要为八个字“海纳百川、唯才是举”。即我们将以大海一般的广阔胸怀，吸纳各种社会精英加入岭南。只要你有才华，在岭南一定会有一个舞台给你，快速发展中的岭南将拥有许多的空缺和机会，只要有才干，在岭南就能够得以施展。同时，我们还不断通过优化人力结构，为员工提供良好的工作环境和公正、公平的事业发展空间。", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/hr/4e9fdb652da59.jpg", 
                        "Url" =>"http://zxqydl.sinaapp.com/hr/wemenu.html");
                        
                        $contentStr[] = array("Title" =>"社会招骋- 招聘岗位·要求...", 
                        "Description" =>"社会招骋", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/hr/sy_2012031814572955901.jpg", 
                        "Url" =>"http://zxqydl.sinaapp.com/hr/wedetail.html");
                        
                        $contentStr[] = array("Title" =>"校园招骋 - 2015校园招聘...", 
                        "Description" =>"校园招骋", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/hr/201312616001487507581.jpg", 
                        "Url" =>"http://zxqydl.sinaapp.com/hr/wedetail1.html");
                        
                        $contentStr[] = array("Title" =>"人才理念 - 用人·育人·留人...", 
                        "Description" =>"人才理念", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/hr/i_rcln_banner1.png", 
                        "Url" =>"http://zxqydl.sinaapp.com/hr/wedetail2.html");
                        
                        $contentStr[] = array("Title" =>"员工福利 - 薪酬·福利·学习...", 
                        "Description" =>"员工福利", 
                        "PicUrl" =>"http://zxqydl.sinaapp.com/images/hr/005WAoe0&690.jpeg", 
                        "Url" =>"http://zxqydl.sinaapp.com/hr/wedetail3.html");
                        break;
 					case "message":
                        $contentStr = $this->transmitERP($object,"message");
 						break;
 					case "email":
                        $contentStr = $this->transmitERP($object,"message");
 						break;	
 					...
 					case "more":
                        $contentStr = $this->transmitERP($object,"message");
 						break;
                    default: 
                        $contentStr[] = array("Title" =>"请选择你关注内容", 
                        "Description" =>"岭南园林是著名园林绿化公司，请关注本公司精品项目，回复 1 即可查看详情。", 
                        "PicUrl" =>"http://www.lnlandscape.com/uploadfile/20130801175059779.jpg", 
                        "Url" =>"");
                        break;
                }
                break;
        ...
        if (is_array($contentStr)){
			foreach($contentStr as $k=>$v){
				$ta[$k] = new NewsResponseItem($v['Title'],$v['Description'],$v['PicUrl'],$v['Url']);
			}
			//$this->responseText('欢迎关注岭南园林股份有限公司官方微信!'.);
			// die;
        	//$this->responseNews($ta);
            $resultStr = $this->transmitNews($object, $contentStr);
        }else{
            $resultStr = $this->transmitERP($object, $contentStr);
        }
		echo $resultStr;
    }   
    
    //文本信息
    private function transmitERP($object, $content, $funcFlag = 0){    	
    	if(empty($_SESSION['Weixinuser'])){
			$appid ="wx228a1c0b4ed30d33";
			$url='https://open.weixin.qq.com/connect/oauth2/authorize?appid='.$appid.'&redirect_uri=http://zxqydl.sinaapp.com/fn_callback.php&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect';
			header("Location:".$url);
		}else{
    ...
    private function transmitNews($object, $arr_item, $funcFlag = 0){
		...
		/*
		$this->responseText('欢迎关注岭南园林股份有限公司官方微信!'.$object->FromUserName);
		die;
		*/
        return $resultStr;
    }
