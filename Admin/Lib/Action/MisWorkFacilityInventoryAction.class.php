 ...
 * @version V1.0
 */
class MisWorkFacilityInventoryAction extends CommonAction  {
	public function lookupinventory(){
		...
		$treemiso[]=array(
				...
				'pId'=>-1,
				'name'=>'设备类型',
				'rel'=>'misworkfacilityinventoryli',
				'target'=>'ajax',
				'url'=>'__URL__/lookupinventory/jump/1',
				'open'=>true
		);
		$param['rel']="misworkfacilityinventoryli";
		$param['url']="__URL__/lookupinventory/jump/1/equipmenttype/#id#";
		...
		if($_REQUEST['jump']){
			$this->display("lookupinventoryview");
		}else{
		 $this->display();
		}
	}
