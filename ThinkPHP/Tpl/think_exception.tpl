...
<div align="center" style="color:#FF3300;margin:5pt;font-family:Verdana"> 用友优普  <sup style='color:gray;font-size:9pt'>项目管理V1.1.5</sup><span style='color:silver'>  -- [ 项  目  定  制  ，  自  由  随  我 ]</span>
</div>
</body>
</html>